...
- Produces:
  - `models.py`: `utcnow_iso() -> str` (ISO-8601 UTC, `timespec="seconds"`); `ChainState` enum (`running`, `waiting`, `fix_error`, `paused`, `done`, `exhausted`); dataclasses `Chain(id:int|None=None, repo:str, workflow_path:str, workflow_name:str, head_branch:str, run_id:int, attempt:int, state:str, next_retry_at:str|None=None, issue_url:str|None=None, last_error:str|None=None, created_at=utcnow, updated_at=utcnow)`, `Retry(chain_id:int, attempt:int, started_at:str, outcome:str, finished_at:str|None=None, sha_before:str|None=None, sha_after:str|None=None, notes:str="", id:int|None=None)`, `Event(delivery_id, run_id, workflow_path, head_branch, head_sha, action, conclusion, handled, workflow_name="", created_at=utcnow, id=None)`.
